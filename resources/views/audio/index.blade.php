        ...
        <div class="col-md-12">
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title"><i class="fa fa-music"></i><strong> Audio</strong></h3>
                </div>
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabel">View Audio</h4>
                </div>
                            ...
                            <div class="panel panel-default">
                                <div class="panel-body profile">
                                    <div class="profile-image">
                                        <img src="/assets/images/gallery/nature-1.jpg" alt="Nature"/>
                                    </div>
                                ...
                                <div class="panel-body">
                                    <div class="contact-info">
                                        ...
                                        <p><small>Photographer</small><br/>Md Karim Molla</p>
                                        <p><small>Location</small><br/>123 45 Street San Francisco, CA, USA</p>
                                        <p><small>Source</small><br/>National Archive Bangladesh</p>
                                        ...
                                        <p><small>External Photo Source</small><br/><a href="#">External Link</a></p>
    ...
    <div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                    <h4 class="modal-title" id="myModalLabel">Edit Audio</h4>
                </div>
                    ...
                    <div class="row">
                        <form class="form-horizontal">
                            <div class="form-group">
                                ...
                                <div class="col-md-8 col-xs-12">
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" value="Sample title of article"/>
                                    </div>
                                    <span class="help-block">eg: Song by Tagore</span>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8 col-xs-12">
                                    <textarea class="form-control" rows="5">This is a long description. This is a long description. This is a long description. This is a long description. </textarea>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8 col-xs-12">
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" value="Mirpur, Dhaka"/>
                                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8 col-xs-12">
                                    ...
                                    <span class="help-block">When was this audio recorded?</span>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8 col-xs-12">
                                    ...
                                    <span class="help-block">When do you want to publish this audio?</span>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8 col-xs-12">
                                    ...
                                    <span class="help-block">Choose tags that relates to your audio</span>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <label class="col-md-3 col-xs-12 control-label">Soundcloud Link</label>
                                <div class="col-md-8 col-xs-12">
                                    <div class="input-group">
                                        <span class="input-group-addon"><span class="fa fa-music"></span></span>
                                        <input type="text" class="form-control" value="www.sound.com/werwef34"/>
                                    </div>
                                    <span class="help-block"> Give the link of the soundcloud link.</span>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8 col-xs-12">
                                    <label class="check"><input type="checkbox" class="icheckbox" checked="checked"/> This is featured audio</label>
                                    <span class="help-block">Do you want to feature this audio?</span>
                                </div>
                            </div>
                        </form>
                    </div>
