                        ...
                        <form class="form-horizontal">
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-xs-12">
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" value="Genocide in Bangladesh"/>
                                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8 col-xs-12">
                                    <div class="input-group">
                                        <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                        <input type="text" class="form-control" value="This is the short description"/>
                                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8 col-xs-12">
                                    <textarea class="form-control" rows="5">Huge description goes here. Huge description goes here. Huge description goes here. Huge description goes here. Huge description goes here.</textarea>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8 col-xs-12">
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" value="Karim Benzema"/>
                                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8 col-xs-12">
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" value="Gazipur, Bangladesh"/>
                                    </div>
