                            ...
                            <div class="form-group">
                                <div>
                                    ...
                                    <div class="col-md-8 col-xs-12">
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" value="We want justice"/>
                                        </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8 col-xs-12">
                                        <div class="input-group">
                                            <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                            <input type="text" class="form-control" value="We are trying a short description"/>
                                        </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8 col-xs-12">
                                        <textarea class="form-control" rows="5">This is a long description</textarea>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8 col-xs-12">
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" value="Jubaida Gulshan Ara Hena"/>
                                        </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8 col-xs-12">
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" value="232-2323-423-4"/>
                                        </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8 col-xs-12">
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" value="PPMC"/>
                                        </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8 col-xs-12">
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" value="239"/>
                                        </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8 col-xs-12">
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" value="www.google.com/aweib2323"/>
                                        </div>
